...
cp "./Astrometric.png" "$TheSkyX_Path/Resources/Common/PlugIns/MountPlugIns/"
...
if [ ! -z "$app_owner" ]; then
	...
	chown $app_owner "$TheSkyX_Path/Resources/Common/PlugIns/MountPlugIns/Astrometric.png"
